...
```
[Manager]
🧠 Manager (Alakazam) starting [Role 0: conducting the loop | Role 1: team orchestration | Role 2: deadlock resolution | Role 3: design council]
```
...
**Announce:** "🧠 Manager (Alakazam) — convening the design council on <artifact>, rule 16(<a|b|c>)"
...
**Announce:** "🧠 Manager (Alakazam) — Role 2b: triaging severity on <finding>"
